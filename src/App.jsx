    ...
    <div style={container}>
      ...
      <div style={page}>
        <div style={{ textAlign: "center", paddingTop: 32, marginBottom: 32 }}>
          <img src="/logo.png" alt="Fundación Red Conecta" style={{ maxWidth: 220, marginBottom: 16 }} />
          <p style={{ color: C.accent, fontSize: 14, fontWeight: 600, marginBottom: 4 }}>Plataforma de Evaluación Vocacional</p>
    ...
    return (
      <div style={container}>
        ...
        <div style={{ ...page, maxWidth: 800 }}>
          <div style={header}>
            <img src="/logo.png" alt="Fundación Red Conecta" style={{ maxWidth: 180, marginBottom: 12 }} />
